<?php
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] == 1) {
        ...
        if (strlen($rut) < 9 || strlen($rut) > 10) {
            ...
            $msg = 'Ingrese el direccion del paciente';
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form name="form" action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="direccion" value="<?php if(isset($_POST['direccion'])) echo $_POST['direccion']; ?>" class="form-control" aria-describedby="empleadoHelpInline">
                    <div id="empleadoHelp" class="form-text text-danger">Ingrese el direccion del Paciente</div>
                </div>
